...
4. **Use shared code.** Common utilities (for example, file path parsing) may exist in the codebase already. Check for library or utility functions before inlining.
