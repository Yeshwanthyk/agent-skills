...
- The judge can know it's judging but sees outputs by sanitized label only, never by worker identity.
...
Every candidate and the judge return, the blind comparison is complete, and the recommendation cites the observed outputs.
