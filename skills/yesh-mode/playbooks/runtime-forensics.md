...
Report the cause, evidence, uncertainty, and the next useful check or correction. Diagnosis does not authorize implementation. If the request includes a fix, continue with [bug fix](bug-fix.md).
