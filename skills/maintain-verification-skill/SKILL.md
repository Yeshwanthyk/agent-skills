...
3. **Source review.** Account for every feature recipe against current entry points and implementation. Load and follow [`references/agent-routing.md`](../../references/agent-routing.md) when delegation earns its overhead. Require concise source evidence and one proposed live recipe per feature.
